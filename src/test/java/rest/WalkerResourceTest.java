...
public class WalkerResourceTest {
    ...
    @Test
    public void testGetAllWalkers() throws Exception {
        ...
        walkerDtos = given()
                ...
                .get("/walkers")
                .then()
                .extract().body().jsonPath().getList("", WalkerDto.class);

        assertThat(walkerDtos, containsInAnyOrder(new WalkerDto(w1), new WalkerDto(w2), new WalkerDto(w3)));
    }
